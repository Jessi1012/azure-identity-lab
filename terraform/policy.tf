...
# Note: Custom policy definitions require 'Resource Policy Contributor' role
# Commenting out to avoid 403 permission error. Enable if you grant the role to your service principal:
#   az role assignment create --assignee <SP_OBJECT_ID> --role "Resource Policy Contributor" --scope /subscriptions/<SUB_ID>
...
#   resource_group_id    = data.azurerm_resource_group.identity_lab.id
